...
export const about =
  "我是李宛莹，中山大学数学学院（珠海）信息与计算科学专业本科生。我的本科训练以数学、统计和计算为主，核心课程包括数理统计、概率论、数值分析、偏微分方程和数据结构与算法。目前我参与持续学习与模型稳定性相关课题，主要关注参数重要性识别、mask 机制和稳定性-可塑性平衡；也曾参与基于 CTT 与 IRT 的教材评估项目，使用隐变量建模和 EM 参数估计方法分析习题质量。未来我希望继续在可靠 AI 推理、统计机器学习和模型稳定性方向接受系统训练。";
...
export const projects: Project[] = [
  {
    ...
    summary:
      "参与持续学习与模型稳定性相关课题，围绕参数重要性识别、重要参数保护与稳定性-可塑性平衡展开训练。目前重点在源码阅读、训练流程梳理、mask 与剪枝机制理解，以及对参数重要性判定规则的分析。",
    background: [
