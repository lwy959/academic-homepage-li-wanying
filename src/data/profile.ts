...
export const about =
  "我是李宛莹，中山大学数学学院（珠海）信息与计算科学专业本科生。我的本科训练以数学、统计和计算为主，核心课程包括数理统计、概率论、数值分析、偏微分方程和数据结构与算法。自 2025 年 9 月起，我在中山大学人工智能学院副教授常晓斌课题组进行科研实习，参与持续学习与模型稳定性相关课题，主要关注参数重要性识别、mask 机制和稳定性-可塑性平衡；也曾参与基于 CTT 与 IRT 的教材评估项目，使用隐变量建模和 EM 参数估计方法分析习题质量。未来我希望继续在统计机器学习、大数据分析、工程智能与可靠 AI 系统等方向接受系统训练，并探索数学统计方法在实际智能系统中的应用。";
